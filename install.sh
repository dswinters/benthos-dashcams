...
sudo cp ornitela_portal_downloader/services/dashcams-ornitela-download-24h.service        /etc/systemd/system
sudo cp ornitela_portal_downloader/services/dashcams-ornitela-download-24h.timer          /etc/systemd/system
...
sudo cp ornitela_portal_downloader/ornitela_copy_24h_data.sh /usr/local/DASHCAMS
...
sudo systemctl enable dashcams-ornitela-download-24h.timer
...
sudo systemctl restart dashcams-ornitela-download-24h.timer
